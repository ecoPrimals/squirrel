...
| Scale | ~**188k** lines across **616** `.rs` files |
...
- **1,539** tests passing (default features), 1 env-dependent flaky test. Full suite ~21s. See `CURRENT_STATUS.md` for authoritative counts.
