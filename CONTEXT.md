...
| Version | **v0.1.0** (workspace); status **pre-alpha** |
...
- **5,574+** tests reported passing (update on version bumps).
...
- **Coverage** ~**72.79%** with **90%** as stated target (re-verify with `just coverage`).
