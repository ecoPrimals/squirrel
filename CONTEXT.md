...
| Scale | ~**452k** lines across **1,334** `.rs` files |
...
- **6,839** tests passing, 0 failures, 107 ignored.
...
- **Coverage** ~**86.5%** line coverage (default features) with **90%** as stated target (re-verify with `just coverage`).
