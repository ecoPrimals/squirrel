...
| Scale | ~**445k** lines across **1,318** `.rs` files |
...
| Version | **v0.1.0-alpha.22** (workspace); status **pre-alpha** |
...
- **6,720** tests passing, 0 failures.
...
- **Coverage** ~**86.0%** line coverage with **90%** as stated target (re-verify with `just coverage`).
