...
| Scale | ~**335k** lines across **~1,032** `.rs` files |
...
- **Discovery service** — registration/heartbeat with ecosystem discovery (ecosystem lifecycle: `lifecycle.register`, `lifecycle.status`).
...
- **7,178** tests passing, 0 failures.
