...
**License**: [scyBorg](LICENSE) (AGPL-3.0-or-later + ORC + CC-BY-SA 4.0) | **Build**: GREEN | **Tests**: 7,012 passing | **Edition**: 2024 | **Coverage**: ~86% | **ecoBin**: 3.5 MB
...
Fitness:   7,012 tests passing (0 failures) | ~1,025 `.rs` files | ~333k lines
