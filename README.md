...
**License**: [scyBorg](LICENSE) (AGPL-3.0-or-later + ORC + CC-BY-SA 4.0) | **Build**: GREEN | **Tests**: 7,192 passing | **Edition**: 2024 | **Coverage**: 90.1% region | **ecoBin**: 3.5 MB
...
Fitness:   7,192 tests passing (0 failures) | ~1,000 `.rs` files | ~327k lines
