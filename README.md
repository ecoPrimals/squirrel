...
**License**: [scyBorg](LICENSE) (AGPL-3.0-or-later + ORC + CC-BY-SA 4.0) | **Build**: GREEN | **Tests**: 7,514 passing | **Edition**: 2024 | **Coverage**: 90.1% region | **ecoBin**: 3.5 MB | **Methods**: 42+ IPC (42 registered + provenance proxy)
...
Fitness:   7,514 tests passing (0 failures) | ~1,029 `.rs` files | ~325k lines | zero Box<dyn Error> in prod
