...
**License**: [scyBorg](LICENSE) (AGPL-3.0-or-later + ORC + CC-BY-SA 4.0) | **Build**: GREEN | **Tests**: 7,171 passing | **Edition**: 2024 | **Coverage**: 90.1% region | **ecoBin**: 4.4 MB | **Methods**: 42+ IPC (42 registered + provenance proxy)
