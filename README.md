...
**License**: [scyBorg](LICENSE) (AGPL-3.0-or-later + ORC + CC-BY-SA 4.0) | **Build**: GREEN | **Tests**: 6,903 passing | **Edition**: 2024 | **Coverage**: ~86% | **ecoBin**: 3.5 MB
...
Fitness:   6,903 tests passing (0 failures) | 997 files | ~332k lines
