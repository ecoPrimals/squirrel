...
impl Plugin for DynamicExamplePlugin {
    fn metadata(&self) -> &dyn squirrel_mcp::plugins::interfaces::PluginMetadata {
        // For dynamic plugins, we need to implement this conversion.
        // In a real implementation, we would have a shared wrapper structure.
        unimplemented!("Example for structure only")
    }
