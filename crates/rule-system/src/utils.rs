...
pub async fn create_rule_file(directory: impl AsRef<Path>, id: &str, content: &str) -> RuleSystemResult<PathBuf> {
...
pub fn serialize_rule_to_yaml(rule: &Rule) -> Result<String, serde_yaml::Error> {
