...
// when integrating with the real dashboard-core
#[cfg(feature = "dashboard")]
use self::dashboard_core::data::{Alert, ProtocolData, DashboardData, Metrics};
#[cfg(feature = "dashboard")]
use self::dashboard_core::monitoring::DashboardDataProvider;
...
impl DashboardExporter {
    ...
    async fn export_spans(spans: &[Span], config: &DashboardExporterConfig) -> Result<(), crate::observability::ObservabilityError> {
        use self::dashboard_core::monitoring::MonitoringDataAdapter;
        use self::dashboard_core::monitoring::MonitoringAdapterConfig;
...
fn create_dashboard_trace_data(spans: &[Span], config: &DashboardExporterConfig) -> DashboardData {
    use self::dashboard_core::data::{DashboardData, Metrics, Alert, ProtocolData};
