...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "✅ Integration created with service ID: {}",
    ...
    let analysis_result = integration
        .ai_intelligence
    ...
    println!(
        "   Active Sessions: {}",
        integration.context_state.get_active_sessions()
    );
    ...
    let intelligence_request = IntelligenceRequest {
        ...
        parameters: {
            ...
            params.insert(
                ...
                serde_json::json!("resource_efficiency"),
            );
            params
        },
        context: Some({
            ...
            context.insert(
                ...
                "performance_focused".to_string(),
            );
            context
        }),
    };

    let intelligence_response = integration
        .provide_ecosystem_intelligence(intelligence_request)
        .await?;
    ...
    println!(
        "   Recommendations: {}",
        intelligence_response.recommendations.len()
    );
    ...
    let coordination_request = McpCoordinationRequest {
        ...
        coordination_data: {
            ...
            data.insert(
                ...
                serde_json::json!("storage_efficiency"),
            );
    ...
    let coordination_response = integration
        .handle_mcp_coordination(coordination_request)
        .await?;
    println!("✅ MCP Coordination Complete:");
    println!(
        "   Coordination ID: {}",
        coordination_response.coordination_id
    );
    println!("   Status: {}", coordination_response.status);
    println!(
        "   Plan Steps: {}",
        coordination_response.coordination_plan.len()
    );
    ...
    let context_request = ContextStateRequest {
        ...
        context_data: Some({
            ...
            data.insert(
                ...
                serde_json::json!("recent_interactions"),
            );
            data
        }),
    ...
    println!(
        ...
        final_health.ai_requests_processed
    );
    println!(
        "   Context States Managed: {}",
        final_health.context_states_managed
    );
    ...
    println!(
        "   AI Capabilities: {}",
        registration.capabilities.ai_capabilities.len()
    );
    println!(
        "   MCP Capabilities: {}",
        registration.capabilities.mcp_capabilities.len()
    );
    println!(
        "   Context Capabilities: {}",
        registration.capabilities.context_capabilities.len()
    );
    println!(
        "   Integration Capabilities: {}",
        registration.capabilities.integration_capabilities.len()
    );
    ...
    if let Ok(openai_key) = std::env::var("OPENAI_API_KEY") {
        ...
        println!(
            "📨 AI Request prepared: {}",
            ai_request.get("model").unwrap_or(&serde_json::Value::Null)
        );
