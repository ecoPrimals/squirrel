...
//! Core JSON-RPC unit tests: serialization, normalization, routing dispatch,
//! batch handling, and protocol edge cases.
//!
//! Transport tests live in `jsonrpc_transport_tests.rs`.
//! Security middleware tests live in `jsonrpc_security_tests.rs`.
