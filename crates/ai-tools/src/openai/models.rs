...
impl OpenAIModel for GPT4 {
    ...
    fn context_window(&self) -> usize { self.context_window }
    fn cost_per_1k_input_tokens(&self) -> f64 { self.cost_per_1k_input_tokens }
    fn cost_per_1k_output_tokens(&self) -> f64 { self.cost_per_1k_output_tokens }
}
