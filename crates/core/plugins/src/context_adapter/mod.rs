...
pub use squirrel_interfaces::context::AdapterMetadata;
pub use plugin::{
    ContextAdapterPluginImpl, create_context_adapter_plugin, create_custom_context_adapter_plugin,
};

/// Context adapter plugin trait (local; `dyn`-safe via boxed futures).
pub trait ContextAdapterPlugin: crate::plugin::Plugin {
