...
pub mod platform_types;      // Platform configuration and state types
...
pub use platform_types::{
    PlatformSettings, PerformanceSettings, SecuritySettings, MonitoringSettings,
    ResourceLimits, PlatformState, PlatformStatus, PlatformMetrics, PlatformHealth,
