...
//!
//! Uses `#[test]` on native hosts so `cargo test` and coverage see these cases; on `wasm32`,
//! `wasm_bindgen_test` is used for `wasm-pack test` workflows.
...
sdk_error_test!(test_enhanced_error_system, {
...
sdk_error_test!(test_error_categorization, {
...
sdk_error_test!(test_error_severity, {
    use severity::PluginErrorClassification;
...
sdk_error_test!(test_recovery_suggestions, {
    use severity::PluginErrorClassification;
...
sdk_error_test!(test_error_context_creation, {
...
sdk_error_test!(test_error_chaining, {
...
sdk_error_test!(test_error_codes, {
...
sdk_error_test!(test_error_conversions, {
...
sdk_error_test!(test_validation_error_conversion, {
...
sdk_error_test!(test_error_recoverability, {
    use severity::PluginErrorClassification;
...
sdk_error_test!(test_enhanced_error_display, {
    let error = core::PluginError::NetworkError {
        operation: "fetch".to_string(),
        message: "timeout".to_string(),
    };
...
sdk_error_test!(test_macro_helpers, {
