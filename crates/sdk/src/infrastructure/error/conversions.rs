...
impl PluginError {
    ...
    pub fn to_js_value(&self) -> JsValue {
        ...
        let _ = js_sys::Reflect::set(&obj, &"type".into(), &self.error_type().into());
        let _ = js_sys::Reflect::set(&obj, &"message".into(), &self.to_string().into());
        let _ = js_sys::Reflect::set(&obj, &"code".into(), &self.error_code().into());
