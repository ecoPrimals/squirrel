...
mod tests {
    use super::{
        CONTENT_TYPE_BINARY, CONTENT_TYPE_JSON, CONTENT_TYPE_TEXT, DEFAULT_CHARSET,
        DEFAULT_CONTENT_TYPE, DEFAULT_MCP_SUBPROTOCOL, DEFAULT_PROTOCOL_VERSION,
        DEFAULT_USER_AGENT, FEATURE_BIDIRECTIONAL_STREAMING, FEATURE_CONTEXT_PRESERVATION,
        FEATURE_MULTI_AGENT, PROTOCOL_VERSION_V2,
    };
