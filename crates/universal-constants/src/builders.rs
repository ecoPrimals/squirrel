...
pub fn get_database_timeout() -> Duration {
    parse_timeout_duration(env_vars::DATABASE_TIMEOUT, timeouts::DEFAULT_DATABASE_TIMEOUT)
}

/// Get heartbeat interval from environment
pub fn get_heartbeat_interval() -> Duration {
    parse_timeout_duration(env_vars::HEARTBEAT_INTERVAL, timeouts::DEFAULT_HEARTBEAT_INTERVAL)
}
...
pub fn get_service_mesh_max_services() -> usize {
    parse_limit(env_vars::SERVICE_MESH_MAX_SERVICES, limits::DEFAULT_MAX_SERVICES)
}
...
pub fn get_connection_timeout() -> Duration {
    parse_timeout_duration(env_vars::CONNECTION_TIMEOUT, timeouts::DEFAULT_CONNECTION_TIMEOUT)
}
